...
function FinancialReport() {
  ...
  const filteredLoansData = financialDetails.filter(
    (detail) => detail.loan_id !== null,
  );
  const filteredSavingsData = financialDetails.filter(
    (detail) => detail.savings_amount !== null,
  );
                    ...
                    <table className="table table-bordered table-hover">
                      ...
                      <tfoot>
                        <tr>
                          ...
                          <th></th>
                          <th>
                            {filteredLoansData.reduce(
                              (total, loan) => total + loan.loan_amount_issued,
                              0,
                            )}
                          </th>
                          <th></th>
                          <th>
                            {filteredLoansData.reduce(
                              (total, loan) => total + loan.loan_amount_due,
                              0,
                            )}
                          </th>
                          <th></th>
                      ...
                      <tbody>
                        {financialDetails.map((insurance, index) => (
                          <tr key={index}>
                            ...
                            <td>
                              {format(
                                new Date(insurance.insurance_expiry),
                                "yyyy-MM-dd",
                              )}
                            </td>
                            <td>active</td>
