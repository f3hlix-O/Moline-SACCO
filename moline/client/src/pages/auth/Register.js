...
const streetNames = [
  "Moi Avenue", "Kenyatta Avenue", "Digo Road", "Uganda Road", "Kenyatta Street", "Jomo Kenyatta Highway" 
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (response.status === 200) {
        Swal.fire({ icon: 'success', title: 'Signup Successful!', text: 'You have successfully signed up.' });
        navigate('/Login');
      } else {
        Swal.fire({ icon: 'error', title: 'Signup Failed', text: response.data.error || 'There was an error signing up.' });
      }
    } catch (error) {
                ...
                <div className="col-lg-30">
                  ...
                  <form onSubmit={handleSubmit} encType="multipart/form-data">
                    ...
                    <div className="row">
                      <div className="col-md-6 mb-4">
                        <div className="form-outline">
                          <input type="text" name="first_name" value={formData.first_name} onChange={handleChange} className="form-control" placeholder=" " required />
                          <label className="form-label">First Name</label>
                        </div>
                      </div>
                      <div className="col-md-6 mb-4">
                        <div className="form-outline">
                          <input type="text" name="last_name" value={formData.last_name} onChange={handleChange} className="form-control" placeholder=" " required />
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6 mb-4">
                        <div className="form-outline">
                          <input type="text" name="phone" value={formData.phone} onChange={handleChange} className="form-control" placeholder=" " required />
                    ...
                    <div className="row">
                      <div className="col-md-6 mb-4">
                        <div className="form-outline">
                          <input type="number" name="national_id" value={formData.national_id} onChange={handleChange} className="form-control" placeholder=" " required />
