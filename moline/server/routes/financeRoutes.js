...
router.get("/userSummary", verifyToken, financeController.getUserSummary);
router.post("/applyLoan", verifyToken, financeController.loanRequest);
router.post("/approveLoan", financeController.approveLoan);
router.post("/disapproveLoan", financeController.disapproveLoan);
// Legacy/admin endpoints expected by the admin UI
router.post("/approveEmergencyLoan", financeController.approveLoan);
router.post("/disapproveEmergencyLoan", financeController.disapproveLoan);
...
router.get("/activeLoans", verifyToken, financeController.getActiveLoans);
...
router.get("/payments/user", verifyToken, financeController.getUserPayments);
router.post(
  "/payments/shareholder",
  verifyToken,
  financeController.shareholderPayment,
);
router.post(
  "/processPayment",
  verifyToken,
  financeController.paymentProcessing,
);
